...
namespace margelo::nitro::concealcrypto {
  ...
  void HybridConcealCryptoSpec::loadHybridMethods() {
    ...
    registerHybrids(this, [](Prototype& prototype) {
      ...
      prototype.registerHybridMethod("hmacSha256", &HybridConcealCryptoSpec::hmacSha256);
      prototype.registerHybridMethod("hmacSha512", &HybridConcealCryptoSpec::hmacSha512);
